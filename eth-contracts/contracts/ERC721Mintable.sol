...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(
            newOwner != address(0),
            "The new owner should be a real address"
        );
...
contract Pausable is Ownable {
    ...
    modifier paused() {
        require(_paused == false, "The contract should be paused.");
        _;
    }
    ...
    function setPaused(bool __paused) public onlyOwner {
        _paused = __paused;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        require(owner != address(0), "the owner address is empty");
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        require(owner != address(0), "owner of the tokenId is not found");
        return owner;
    }
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "the to address is the owner address");
